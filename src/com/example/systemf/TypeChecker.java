...
//		envList.add(new Pair<>("fromRecord", new FunType(new StrType(), server, new FunType(new IntType(), server, new StrType()))));
		...
		envList.add(new Pair<>("primCreateTable", new FunType(new StrType(), server, new FunType(new StrType(), server, new BoolType()))));
		envList.add(new Pair<>("primInsertRecord", new FunType(new StrType(), server, new FunType(new StrType(), server, new IntType()))));
		...
		envList.add(new Pair<>("primQuery", new FunType(new StrType(), server, new FunType(new StrType(), server, new FunType(new StrType(), server, new StrType())))));
		envList.add(new Pair<>("primFromRecord", new FunType(new StrType(), server, new FunType(new StrType(), server, new StrType()))));
